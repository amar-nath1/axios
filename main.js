...
function getTodos() {
  ...
  // })
  axios.get('https://jsonplaceholder.typicode.com/todos?_limit=10',{timeout:500})
...
// SIMULTANEOUS DATA
function getData() {
  axios.all([axios.get('https://jsonplaceholder.typicode.com/todos?_limit=7'),axios.get('https://jsonplaceholder.typicode.com/posts?_limit=10')])
  .then(([todos,posts])=>{showOutput(posts)})
  .catch(err=>console.log(err))
}
